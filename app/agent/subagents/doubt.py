...
_PROMPT_PATH = _PROMPTS_DIR / "subagents" / "doubt_prompt.txt"
...
async def run_doubt_agent(
    *,
    ...
    """Run the doubt solver subagent. No tools — pure LLM reasoning."""
    ...
    logger.info("Doubt agent completed in %.2fs (%d chars)", elapsed, len(text))
